...
const TestScreen = ({ onCompleteTest, onCancelTest }) => {
  ...
  const handleAnswerSelect = (type, descriptorIndex) => {
    ...
    currentAnswer[type] =
      currentAnswer[type] === descriptorIndex ? null : descriptorIndex;
  ...
  const calculateResults = () => {
    ...
    onCompleteTest({
      ...
      details: {
        ...
        [NEUTRAL_FACTOR]: {
          plus: scores[NEUTRAL_FACTOR].plus,
          minus: scores[NEUTRAL_FACTOR].minus,
        },
      },
    });
  };
    ...
    <div className="test-screen">
      <div className="container">
        ...
        <div className="instructions">
          ...
          <ul>
            <li>
              <strong>+</strong> - характеристика, которая больше всего похожа
              на вас
            </li>
            <li>
              <strong>-</strong> - характеристика, которая меньше всего похожа
              на вас
            </li>
          </ul>
        </div>
        ...
        <div className="question-block">
          ...
          {currentQ.descriptors.map((descriptor, index) => (
            <div
              key={index}
            ...
            >
              <div className="descriptor-text">
                {descriptor.text}
                {!descriptor.factor && (
                  <span className="neutral-badge"> (не учитывается)</span>
                )}
              </div>
        ...
        <div className="navigation">
          ...
          <div>
            ...
            <button
              ...
              onClick={handleNext}
              disabled={
                answers[currentQuestion].plus === null ||
                answers[currentQuestion].minus === null
              }
            >
